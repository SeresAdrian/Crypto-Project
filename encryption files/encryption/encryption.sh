...
do
	...
	echo -e " [ 07 ] \e[93mMorse code encryption\e[0m"
        ...
        #               fi
                 ...
                 03)
                        ...
                        ;;
                 04)
                       python3 encryption/baconianenc.py 
                        ;;
                 05)
			python3 encryption/xorenc.py 
                        ;;
                 06)
                        python3 encryption/affineenc.py
                        ;;
		 07)
                        python3 encryption/morseenc.py
                        ;;
                 08)
                        python3 encryption/substituioncipherenc.py
                        ;;
		 09)
                       python2 encryption/rsa.py
                        ;;
                 00)
                        clear
                        exit 1
